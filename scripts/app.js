...
// Katakana
function displayKata() {
    var letters = ["ア", "イ", "ウ", "エ", "オ", "カ", "キ", "ク", "ケ", "コ", "キャ", "キュ", "キョ", "サ",
    ...
    document.getElementById("button").setAttribute("onClick", "javascript: checkKata();");
...
function checkKata() {
    ...
    if ((document.getElementById("answer").value) == table[document.getElementById("display").innerText]) {
        document.getElementById("answer").value = "yes";
        document.getElementById("display").style.background = "#d7f3de";
        score(true);
    }
    else {
        document.getElementById("answer").value = table[document.getElementById("display").innerText];
        document.getElementById("display").style.background = "#f7dce0";
        score(false);
    }
    document.getElementById("button").setAttribute("onClick", "javascript: displayKata();");
    document.getElementById("button").innerText = "next";
}
// Hiragana
function displayHira() {
    var letters = ["あ", "い", "う", "え", "お",
        "か", "き", "く", "け", "こ", "きゃ", "きゅ", "きょ",
        "さ", "し", "す", "せ", "そ", "しゃ", "しゅ", "しょ",
        "た", "ち", "つ", "て", "と", "ちゃ", "ちゅ", "ちょ",
        "な", "に", "ぬ", "ね", "の", "にゃ", "にゅ", "にょ",
    ...
    document.getElementById("display").style.background = "#A2BDC6";
    document.getElementById("answer").value = "";
    document.getElementById("button").setAttribute("onClick", "javascript: checkHira();");
    document.getElementById("button").innerText = "check";
    document.getElementById("answer").focus();
}
function checkHira() {
    ...
    document.getElementById("button").setAttribute("onClick", "javascript: displayHira();");
    document.getElementById("button").innerText = "next";
}
